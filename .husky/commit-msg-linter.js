...
//   '\\[(?:(?:[Ff]eat|FEAT)|(?:[Ff]ix|FIX)|(?:[Cc]onfig|CONFIG)|(?:[Ss]tyle|STYLE)|(?:[Tt]est|TEST)|(?:[Dd]oc|DOC)|(?:[Hh]otfix|HOTFIX)|(?:[Rr]efactor|REFACTOR)|(?:[Aa]ssets|ASSETS)|(?:[Bb]uild|BUILD))(?:-\d+)?\]: .+'
// );
const pattern = new RegExp(
  '(?:\\[(?:[Ff]eat|FEAT|[Ff]ix|FIX|[Cc]onfig|CONFIG|[Ss]tyle|STYLE|[Tt]est|TEST|[Dd]oc|DOC|[Hh]otfix|HOTFIX|[Rr]efactor|REFACTOR|[Aa]ssets|ASSETS|[Bb]uild|BUILD)(?:-\\d+)?\\]|(?:[Ff]eat|FEAT|[Ff]ix|FIX|[Cc]onfig|CONFIG|[Ss]tyle|STYLE|[Tt]est|TEST|[Dd]oc|DOC|[Hh]otfix|HOTFIX|[Rr]efactor|REFACTOR|[Aa]ssets|ASSETS|[Bb]uild|BUILD)(?:-\\d+)?) ?: .+'
);
